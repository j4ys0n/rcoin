/*!
 * workerpool.js - worker processes for rcoin
...
class WorkerPool extends EventEmitter {
  ...
  constructor(options) {
    ...
    this.size = getCores();
    this.timeout = 120000;
    this.file = process.env.RCOIN_WORKER_FILE || 'worker.js';
...
class Worker extends EventEmitter {
  ...
  listen() {
    ...
    this.sendEnv({
      RCOIN_WORKER_NETWORK: Network.type,
      RCOIN_WORKER_ISTTY: process.stdout
