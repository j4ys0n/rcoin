/*!
 * compress.js - coin compressor for rcoin
 ...
 * the fact that many ravencoin values are divisible by 10.
 * @see https://github.com/rvnsuite/rvnd/blob/master/blockchain/compress.go
 * @param {Amount} value
 * @returns {Number}
 */
