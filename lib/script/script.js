/*!
 * script.js - script interpreter for rcoin
...
const ripemd160 = require('rcrypto/lib/ripemd160');
const sha1 = require('rcrypto/lib/sha1');
const sha256 = require('rcrypto/lib/sha256');
...
class Script {
  ...
  /**
   * Convert the script to a ravencoind test string.
   * @returns {String} Human-readable script code.
   */
  ...
  /**
   * Format the script as ravencoind asm.
   ...
   * @see https://test.webrvn.com/tx/19aa42fee0fa57c45d3b16488198b27caaacc4ff5794510d0c17f173f05587ff
   ...
   * ravencoin itself requires scripthashes to be in strict minimaldata
   ...
   * program (mimics ravencoind's scriptForWitness).
   * @returns {Script|null}
   */
  ...
  /**
   * Inject properties from ravencoind test string.
   * @private
  ...
  /**
   * Parse a ravencoind test script
