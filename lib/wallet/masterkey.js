/*!
 * masterkey.js - master bip32 key object for rcoin
...
const cleanse = require('rcrypto/lib/cleanse');
const aes = require('rcrypto/lib/aes');
...
const scrypt = require('rcrypto/lib/scrypt');
...
MasterKey.SALT = Buffer.from('rcoin', 'ascii');
