/*!
 * keyring.js - keyring object for rcoin
...
class KeyRing {
  ...
  /**
   * Convert key to a CRavencoinSecret.
  ...
  /**
   * Inject properties from serialized CRavencoinSecret.
   * @private
  ...
  /**
   * Instantiate a keyring from a serialized CRavencoinSecret.
   * @param {Base58String} secret
   * @param {(Network|NetworkType)?} network
   * @returns {KeyRing}
   */
