/*!
 * pool.js - peer management for rcoin
...
const dns = require('rdns');
const tcp = require('rvnp');
const UPNP = require('rupnp');
const socks = require('rsocks');
const List = require('rlst');
const {BloomFilter, RollingFilter} = require('rfilter');
...
class Pool extends EventEmitter {
   ...
   * remote:8767->local:8767) via UPNP.
   * @returns {Promise}
   */
