/*!
 * miner.js - block generator for rcoin
...
/**
 * Miner
 * A ravencoin miner and block generator.
...
class MinerOptions {
  ...
  constructor(options) {
    ...
    this.version = -1;
    this.addresses = [];
    this.coinbaseFlags = Buffer.from('mined by rcoin', 'ascii');
