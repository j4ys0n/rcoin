...
describe('Utils', function() {
  ...
  it('should convert satoshi to rvn', () => {
    assert.strictEqual(Amount.rvn(5460), '0.0000546');
    assert.strictEqual(Amount.rvn(54678 * 1000000), '546.78');
    assert.strictEqual(Amount.rvn(5460 * 10000000), '546.0');
  });

  it('should convert rvn to satoshi', () => {
